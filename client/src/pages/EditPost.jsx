...
export const EditPost = () => {
  ...
  return (
    ...
    >
      <label className="text-gray-300 py-2 bg-gradient-to-r from-[#5271FF] to-[#05CCCB] text-[1p8x] font-semibold mt-2 flex items-center justify-center border-2 border-dotted cursor-pointer">
      ...
      <label className="text-xs text-white opacity-70">
        ...
        <textarea
          ...
          className="mt-1 text-black w-full rounded-lg bg-gradient-to-r from-[#5271FF] to-[#05CCCB]  border py-1 px-2 text-xs outline-none resize-none h-40 placeholder:text-gray-700"
        />
      </label>
